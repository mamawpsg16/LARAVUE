<template>
    <Navbar/>
    <div class="p-4">
        <h1 class="text-2xl font-bold text-center">MODULES</h1>
        ...
        <div class="flex justify-end">
                <p class="text-lg">Count: {{ modules.length }}</p>
        </div>
            ...
            >
                ...
                >
                    <div>
                        <div class="space-y-3">
                            <p class="mt-2">
                                <span class="text-lg">Name: </span>{{ module_.name }}
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                > <i :class="module_?.icon" ></i> {{ module_?.icon }}
        ...
        <p v-else class="mt-4">No Modules Yet...</p>
    </div>
</template>
...
const deleteModule = function (module_id) {
    Swal("Delete Module!", "Are you sure?", "warning", "Yes", {
