            ...
            <div class="bg-white rounded-lg shadow-lg space-y-2 w-2/4">
                <div class="flex justify-center">
                    <div class="w-40 h-40 rounded-full overflow-hidden">
                        <!-- <img
                            src="{{ task.user?.profile_picture ? task.user?.profile_picture : defaultImage }} "
                            alt="Profile Picture"
                            class="object-cover w-full h-full"
                        /> -->
                        <img v-if="task.user?.profile_picture" :src="task.user.profile_picture"  alt="Profile Picture"
                            class="object-cover w-full h-full">
                        <img v-else :src="defaultImage"  alt="Profile Picture"
                            class="object-cover w-full h-full">
                    </div>
                </div>
                <div v-if="task.user">
